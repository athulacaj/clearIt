...
class RapidFireQuestionAnswersProvider extends ChangeNotifier {
  int questionIndex = 0;
  int previousIndex = -1;
...
//      Map cData = data.fromJson(jsonresponse[0]);
      ...
      for (var answerMap in answeredList) {
        int i = answerMap['timeSpend'];
        totalTimeSpend = totalTimeSpend + i;
      }
    }
    notifyListeners();
  }
  ...
  void addOptionToAnswerList({required int optionSelected}) {
